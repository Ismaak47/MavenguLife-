...
const SoulMission = {
    getSoulMission: function (lifePath) {
        const missions = {
            ...
            4: "Kujenga misingi imara. Lengo lako ni kutengeneza utulivu na mpangilio kwa ajili ya vizazi vijavyo.",
    ...
    getShadowWork: function (zodiacSign) {
        const shadows = {
            ...
            "Virgo": "Upendeleo wa ukamilifu na ukosoaji. Jifunze kujihurumia na kukubali mapungufu.",
